...
cv2.arrowedLine(img, pt1=(21, 13), pt2=(151, 401), color=(0, 0, 255), thickness=5)
...
cv2.ellipse(img, center=(256, 256), axes=(100, 50), angle=0, startAngle=0, endAngle=270, color=255,
...
cv2.putText(img, text='bottomLeftOrigin', org=(10, 400), fontFace=font, fontScale=1, color=(255, 255, 255), thickness=1,bottomLeftOrigin=False)
