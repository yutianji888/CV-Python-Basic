...
class get_linklist_vertica(object):
    ...
    def get_linklist(self):
        ...
        # sql = """
        #     select v.video_path from facebookods.fb_videos v LIMIT 4;
        # """
        sql = """
                select v.video_path from facebookods.fb_videos v where v.video_path not in
                (SELECT t.video_path FROM datamining.dmn_fb_video_fingerprint t GROUP BY t.video_path)
