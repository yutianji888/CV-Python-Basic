...
print("image: {0}, type: {1}".format(image, type(image)))
print("contours type: {0}".format(type(contours)))
print("hierarchy type: {0}".format(type(hierarchy)))
...
simplified_cnt = cv2.approxPolyDP(hull, epsilon, True) # 对图像轮廓点进行多边形拟合
